...
const MenuNav = ({ data, setItem, isItemsOpen, setIsItemsOpen, toggleMenuItems, getCatalogName, setIsOpen }) => {
  ...
  return (
    <div className={isItemsOpen ? 'w-full fixed bottom-0 transition-all duration-600 z-50 shadow-3xl lg:w-[30%]' : 'w-full fixed -bottom-half-screen transition-all duration-600'}>
