...
const Navbar = ({ toggleMenu, isOpen }) => {
    return (
      <div className={isOpen ? "w-full flex flex-col items-center py-8 fixed top-[80px] left-0 right-0 bottom-0 bg-DimGray transition-all z-50" : "h-0 opacity-0 transition-all"}>
