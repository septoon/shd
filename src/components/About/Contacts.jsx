...
import AddressIcon from '../../assets/img/location.svg'
    ...
    <div className='pt-6 w-full h-full flex flex-col'>
      ...
      <div className='w-full flex flex-col pl-3'>
        <div className='flex items-center mb-3'>
          <img src={PhoneIcon} className='w-8 mr-4' alt="phone" />
        ...
        <div className='flex items-center mb-3'>
          <img src={AddressIcon} className='w-8 mr-4' alt="address" />
          <div className='flex flex-col'>
            <span>Адрес</span>
        ...
        <div className='flex items-center mb-3'>
          <img src={ClockIcon} className='w-8 mr-4' alt="clock" />
          <div className='flex flex-col'>
